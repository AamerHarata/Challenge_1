#pragma checksum "D:\GitFolders\Programming\Twente\TestGoogle\Views\Challenge_2\Map.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "db1edecb096943ce662fcea1d1aaf052feabf291"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"db1edecb096943ce662fcea1d1aaf052feabf291", @"/Views/Challenge_2/Map.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "db1edecb096943ce662fcea1d1aaf052feabf2915965", async() => {
            }
            );
    ...
    <script>
        $(document).ready(function() {
            ...
            setElementPos(mobile, map, 19.5, 31.80);
...
//            getIntersection(circle_1, circle_2, circle_3);
            ...
            function anyIntersection(src_1, src_2, src_3) {
                ...
                const d_1_3 = Math.sqrt( sq2(src_3.x - src_1");
                WriteLiteral(@".x) + sq2(src_3.y - src_1.y));
            ...
            function getIntersection(src_1, src_2, src_3) {
                ...
                const Eclipse_x_1_2");
                WriteLiteral(@" = src_1.x + (d_x_1_2 * a_1_2/d_1_2);
    ...
    ");
                WriteLiteral(@"            const intersection_2_y_1_3 = Eclipse_y_1_3 - offset_1_3_y;
...
//                    intersection_2_x_1_3 + "", "" + i");
                WriteLiteral(@"ntersection_2_y_1_3 + "")"");
...
//                    intersection_2_x_2_3 + "", "" + intersection_2_y_2_3 + "")"");
                ...
                const d_1_2_ = Math.sqrt(sq2(src_1.x - intersectio");
                WriteLiteral(@"n_2_x_2_3) + sq2(src_1.y - intersection_2_y_2_3));
                ...
                //Collect the corr");
                WriteLiteral(@"ect point for intersection between 1 and 3
                if (d_2_1 < d_2_2){
                ...
                console.log(""Triangle Intersection between 1 and 2.. x: "" + trianglePoint_1_x_B_1_2");
                WriteLiteral(@" + "", y: "" + trianglePoint_1_y_B_1_2);
...
//                
//       ");
                WriteLiteral(@"         let posX = $(mapPic).offset().left - $(element).width()/2;
//                let posY = $(mapPic).offset().top - $(element).height()/2 + realHeight;
//
//                posX += x;
//                posY -= y;
