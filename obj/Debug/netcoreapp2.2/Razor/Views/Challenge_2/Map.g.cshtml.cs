#pragma checksum "D:\GitFolders\Programming\Twente\TestGoogle\Views\Challenge_2\Map.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "525072a13bc10237ba4f47dadaa30c6dd702325a"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"525072a13bc10237ba4f47dadaa30c6dd702325a", @"/Views/Challenge_2/Map.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "525072a13bc10237ba4f47dadaa30c6dd702325a5965", async() => {
            }
            );
...
//            getIntersection(circle_1, circle_2, circle_3);
            ...
            function getIntersection(src_1, src_2, src_3) {
                ...
                const d_1_3 = Math.sqrt(sq2(src_3.x - src_1.x) + sq2(src_3.y - src_1.y));
                const");
                WriteLiteral(@" d_2_3 = Math.sqrt(sq2(src_3.x - src_2.x) + sq2(src_3.y - src_2.y));
                ...
                //Distance from point in eclipse to on");
                WriteLiteral(@"e of intersection points
...
//                  ");
                WriteLiteral(@"  intersection_2_x_1_2 + "", "" + intersection_2_y_1_2 + "")"");
...
//                    intersection_2_x_2_3 + "", "" + intersection_2_y_2_3 + "")"");
                ...
                if (d_3_1 < d_3_2) {
                    ...
                    trianglePoint_1_x_B_1_2 = inter");
                WriteLiteral(@"section_2_x_1_2;
                ...
                console.log(""Tria");
                WriteLiteral(@"ngle Intersection between 1 and 2.. x: "" +
                    trianglePoint_1_x_B_1_2 +
                    "", y: "" +
                    trianglePoint_1_y_B_1_2);
                console.log(""Triangle Intersection between 1 and 3.. x: "" +
                    trianglePoint_2_x_B_1_3 +
                    "", y: "" +
                    trianglePoint_2_y_B_1_3);
                console.log(""Triangle Intersection between 2 and 3.. x: "" +
                    trianglePoint_3_x_B_2_3 +
                    "", y: "" +
                    trianglePoint_3_y_B_2_3);
            ...
            function track() {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        const circ_2 = { x: response.b2.x, y: response.b2.y, r: response.b2.estim");
                WriteLiteral(@"atedDistance }
